...
if(isset($_REQUEST["insert"])){ //This also works for inserting data.  Image still not inserted though
...
}//this would be the end of the isset function.  with it here it was adding all data except for image to database.
//Checks Connection
  if (!$conn){
  ...
  //if(isset($_REQUEST["insert"])){
    $file = addslashes(file_get_contents($_FILES["DogPic"]["tmp_name"]));//"DogPic" used to be "image" it is now adding image
...
//}//testing it here to see if it inserts image to database failed
...
//}//ended the isset function here to see if it will add image to database. failed
//}
